...
import { ChevronLeft, UserPlus, Mail, Phone, Shield, Save, AlertCircle } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        <div className="p-8 border-b border-gray-100 bg-gray-50/50 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 tracking-tight">Editar Usuario</h1>
            <p className="text-gray-500 font-medium">Actualiza la información de la cuenta.</p>
          </div>
        </div>
